...
// Exact port of DMS builtin DesktopClockWidget
// (Modules/BuiltinDesktopPlugins/DesktopClockWidget.qml)
// Root adapted from Item -> DesktopPluginComponent so it runs as wb-clock.
// Only cfg source + minWidth/minHeight declarations changed; everything else verbatim.
DesktopPluginComponent {
    ...
    readonly property var cfg: instanceConfig ?? null
    ...
    readonly property color backgroundColor: Theme.surfaceContainer
